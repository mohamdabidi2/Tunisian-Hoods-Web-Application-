...
const OpenSupportMessageTicket = (props) => {
...
setAdmins(res.data)
    ...
    const acreject=(e)=>{
   if(Message!==""){
    Axios.post("/admindashboard/sendSupportEmail",{...e,AdminRes:Message},{headers:{authToken:localStorage.getItem('Token')}})
    props.history.push("/admin/dash/SupportMessage/list/add")
   }
else{
  ...
  <div className="content-wrapper">
   ...
   <div className="faded">
       ...
       <div className="btn">
           ...
           <button className="btn btn-danger"  onClick={()=>acreject(el)}>Send Email Message</button>
       </div>
   </div>
      )}
      </div>
...
export default withRouter(OpenSupportMessageTicket);
